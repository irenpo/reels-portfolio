...
export const profile = {
  ...
  heading: 'Рилс, которые попадают в тренды.',
  description:
    'Я снимаю тот самый момент, когда «прикольное видео» превращается в «где это купить?». Нахожу тренд, в котором продукт выглядит естественно, и собираю ролик вокруг продажи — без рекламы в лоб.',
